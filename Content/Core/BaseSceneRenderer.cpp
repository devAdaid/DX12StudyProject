...
BaseSceneRenderer::BaseSceneRenderer(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void BaseSceneRenderer::CreateDeviceDependentResources()
{
	CreateRootSigniture();

	auto createVSTask = CreateVertexShaderTask();
...
Concurrency::task<void> BaseSceneRenderer::CreateVertexShaderTask()
{
	return DX::ReadDataAsync(L"SampleVertexShader.cso").then([this](std::vector<byte>& fileData) {
		m_vertexShader = fileData;
		});
}

Concurrency::task<void> BaseSceneRenderer::CreatePixelShaderTask()
{
	return DX::ReadDataAsync(L"SamplePixelShader.cso").then([this](std::vector<byte>& fileData) {
		m_pixelShader = fileData;
		});
}

void BaseSceneRenderer::CreatePipelineState()
{
...
void BaseSceneRenderer::CreateWindowSizeDependentResources()
{
...
void BaseSceneRenderer::Update(DX::StepTimer const& timer)
{
...
void BaseSceneRenderer::SaveState()
{
...
void BaseSceneRenderer::LoadState()
{
	auto state = ApplicationData::Current->LocalSettings->Values;
	if (state->HasKey(AngleKey))
	{
...
void BaseSceneRenderer::TrackingUpdate(float positionX)
{
	if (m_tracking)
	{
...
void BaseSceneRenderer::StopTracking()
{
	m_tracking = false;
}

// Renders one frame using the vertex and pixel shaders.
bool BaseSceneRenderer::Render()
{
